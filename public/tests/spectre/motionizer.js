 ...
 */
var Motionizer = function (elem, initRotate, otherTransform, rotateZ) {
    ...
    var _element;
    var _initRotate = initRotate || 0;
    var _rotateZ = (typeof rotateZ == "undefined") ? true : rotateZ;
    var _otherTransform = otherTransform || "";
    var _windowOrientation = 0;

    /*this.update = function (msg) {
        if (msg.event == 'deviceorientation') {
            _windowOrientation = msg.orientation;
            _orientationHelper.ev = msg;
    ...
    var _init = function () {
        ...
        window.addEventListener("deviceorientation", function (ev) {
            console.log("deviceorientation", ev);
            _orientationHelper.ev = ev;
        }, false);

        window.addEventListener("orientationchange", function () {
            _windowOrientation = window.orientation || 0;
        }, false);
    ...
    var _animate = function () {
        ...
        if (_rotateZ) {
            style += "rotateZ(" + (_initRotate + _orientationHelper.getZDeg()) + "deg)";
        }
        style += _otherTransform;
